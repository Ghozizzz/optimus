...
<div class='image-container'>          
  <div class="photo-grid-container" align="center" width="80%" style="margin-top:10px;"></div>
        ...
        <div class="container mt-5" id="parent" style="position:relative;">
          <form action="{{ url('image') }}" method="post" enctype="multipart/form-data">
              <div class="form-group">
                  <label for="exampleInputImage">Image:</label>
                  <input type="file" name="profile_image" id="profile_image" class="image" required>
          ...
          <div class="row mt-5">
              <p><img id="previewimage" style="display:none; width: 600px"/></p>
          </div>
        </div>


        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="close_selection()">Close</button>
  ...
  <script src="{{ URL::to('/') }}/assets/js/jquery.imgareaselect.min.js" type="text/javascript"></script>
  <script>
      ...
      $(function($) {
        $('#profile_image').on('change', function()  { 
          ...
          imgPreview = $('#previewimage').imgAreaSelect({
              handles: true,
              aspectRatio: '1:1',
              instance: true,
