      ...
      <ul class="list-unstyled components">
          <li>
              ...
              <ul class="collapse list-unstyled child-menu" id="homeSubmenu">
                  ...
                  <li>
                      <a href="{{ route('admin.carcolor') }}" class="active">Car Color</a>
                  </li>
                  <li>
                      <a href="{{ route('admin.cartype') }}" class="active">Car Type</a>
                  </li>
                  <li>
                      <a href="{{ route('admin.banner') }}" class="active">Banner</a>
                  </li>
                  <li>
                      <a href="{{ route('admin.country') }}" class="active">Country</a>
                  </li>
                  <li>
                  ...
                  <li>
                      <a href="{{ route('admin.accessories') }}" class="active">Accessories</a>
                  </li>
              </ul>
          </li>
          <li>
          ...
          <li>
              ...
              <ul class="collapse list-unstyled child-menu" id="crmSubmenu">
                  <li>                      
                    <a href="{{ route('admin.negotiation') }}" class="active">Negotiation <span class='notif'>{{$total_unread_message}}</span></a>
                  </li>
                  <li>                      
                      <a href="{{ route('admin.orderlist') }}" class="active">Order List <span class='notif'>{{$total_unread_order}}</span></a>
                  </li>                  
                  <li>
                      <a href="{{ route('admin.invoice') }}" class="active">Payment <span class='notif'>{{$total_active_payment}}</span></a>
                  </li>
                  <li>
                      <a href="{{ route('admin.reviewlist') }}" class="active">Review <span class='notif'>{{$total_moderated_review}}</span></a>
                  </li>
                  <li>
