    ...
    <div class="col-md-10 right-menu-div">
      <div class='wraper'>
        ...
        <div class='admin-content'>
          ...
          @endphp
          @if(isset($negotiation) && count($negotiation)>0)
          <div width="100%">
            ...
            <?php if(count($negotiation_line)>0){
              foreach($negotiation_line as $negotiation_line_detail){
                if($negotiation_line_detail->customer_chat_id === $session['user_id']){?>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <?php echo date_format(date_create($negotiation_line_detail->createdon),"d-m-Y") ?>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 user-chat-div">                      
                      {{$negotiation_line_detail->chat}}
                    </div>
                  </div>
                ...
                <?php }?>
                <?php }elseif($negotiation_line_detail->user_chat_id !== Null){?>
                <div class="row">
                    <div class="col-md-12">
                      <b>Sales</b>
                    </div>
                ...
                <form action="{{route('customer.createNegotiate')}}" method="post">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      @else
                        <button class='btn btn-danger'>Create Negotiation</button>
                      @endif
                    </div>
                  </div>
                </form>
