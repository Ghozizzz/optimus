  ...
  <script>
    ...
    $('#newModal').on('show.bs.modal', function (event) {
      ...
      if(typeof ids !== 'undefined'){
        ...
        var modal = $(this)
          $.get("{{ URL::to('/') }}/admin/cartype/view/" + ids, function(response) {
    ...
    function updateData(){
            ...
            data.append('description', $('#description').val());
            $.ajax({
            url: "{{ URL::to('/') }}/admin/cartype/update/" + id,
                    type: "POST",
                    data:  data,
                    processData: false,
                    contentType: false,
   ...
   function deleteData(id){
    ...
    title: "Are you sure?",
            ...
            $.get("{{ URL::to('/') }}/admin/cartype/delete/" + id, function(response) {
            location.reload();
            });
            } else {
