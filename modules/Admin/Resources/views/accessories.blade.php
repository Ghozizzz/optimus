...
<div class="full-container">
  ...
  <script>
    ...
    function newData(){
      ...
      $.ajax({
      url: "{{ URL::to('/') }}/admin/accessories/save",
              type: "POST",
              data:  data,
              processData: false,
              contentType: false,
    ...
    $('#newModal').on('show.bs.modal', function (event) {
      ...
      if(typeof ids !== 'undefined'){
        ...
        var modal = $(this)
          $.get("{{ URL::to('/') }}/admin/accessories/view/" + ids, function(response) {
    ...
    function updateData(){
            ...
            data.append('description', $('#description').val());
            $.ajax({
            url: "{{ URL::to('/') }}/admin/accessories/update/" + id,
                    type: "POST",
                    data:  data,
                    processData: false,
                    contentType: false,
   ...
   function deleteData(id){
    ...
    title: "Are you sure?",
            ...
            $.get("{{ URL::to('/') }}/admin/accessories/delete/" + id, function(response) {
            location.reload();
            });
            } else {
