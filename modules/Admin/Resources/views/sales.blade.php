...
$('#editModal').on('show.bs.modal', function (event) {
  ...
  var modal = $(this)
	 $.get( "{{ URL::to('/') }}/admin/sales/view/"+ids, function( response ) {
...
function updateData(){
	...
	$.ajax({  
	    url: "{{ URL::to('/') }}/admin/sales/update/"+id,  
	    type: "POST",  
	    data:  data,
	    processData: false,  
	    contentType: false, 
...
function deleteData(id){
	...
	.then((willDelete) => {
 	...
 	$.get( "{{ URL::to('/') }}/admin/sales/delete/"+id, function( response ) {
		location.reload();
	});
