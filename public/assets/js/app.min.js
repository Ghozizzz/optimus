    ...
    var app = (function () {
        ...
        $(window).on('scroll', function () {
            var $scrollPos = $(this).scrollTop(),
                    ...
                    $case = $('.case'),
                    $caseFig = $case.find('figure'),
                    $caseImg = $caseFig.find('img'),
                    $findLi = $wwDC.find('li');
            ...
            if ($scrollPos > 10) {
                ...
                $caseImg.eq(0).css({'left': -430 - ($scrollPos) / 5 + 'px'});
                $caseImg.eq(1).css({'right': -350 - (($scrollPos) / 5) + 'px'});
            }
            ...
            if (typeof $wwDC.offset() !== 'undefined') {
            ...
            if(typeof $('div.news-update').offset() !== 'undefined'){
