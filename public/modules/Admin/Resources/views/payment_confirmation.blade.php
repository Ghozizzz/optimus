    ...
    <div class="col-md-10 right-menu-div">
      <div class='wraper'>
        ...
        <div class='admin-content'>
          ...
          <div class="height10"></div>
          <form method='post' action="{{route('admin.paymentConfirmationSave')}}" enctype="multipart/form-data">
              ...
              <div class='col-md-9'>
                ...
                <div class='row padding5'>
                  ...
                  <div class='col-md-8'>
                    <div class='row'>
                      <div class='col-md-6'>
                        <input type="text" class="form-control" name="invoice-number" id="invoice-number" value="{{isset($invoice->invoice_number)?$invoice->invoice_number:''}}">
                      </div>                      
                    </div>
