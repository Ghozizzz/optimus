<table width="100%">
  <tr>
    <td width="12%" align="center">
      <?php
        if(isset($session['negotiation'])){
          $link = route('admin.negotiation.view',['id'=>$session['negotiation']->id]);
        }else{
          $link = '#';
        }
      ?>
      <a href="{{$link}}" class="order-process"><img src="{{URL::to('/')}}/assets/images/step1.png" alt="step1">
        <br>
    ...
    <td width="12%" align="center" class="order-process"> 
      <?php
        ...
        if(isset($session['proforma_invoice'])){
          $link = route('admin.proformainvoice',['id'=>$session['proforma_invoice']->id]);
        }else{
          $link = '#';
        }
      ?>
    ...
    <td width="12%" align="center" class="order-process">
      <?php
        if(isset($session['invoice'])){
          $link = route('admin.negotiationInvoice',['id'=>$session['invoice']->id]);
        }else{
          $link = '#';
        }
    ...
    <td width="12%" align="center" class="order-process">
      <?php
        if(isset($session['invoice'])){
          $link = route('admin.paymentConfirmation',['invoice_id'=>$session['invoice']->id]);
        }else{
          $link = '#';
        }
      ?>
    ...
    <td width="12%" align="center" class="order-process">
      <?php
        if(isset($session['invoice'])){
          $link = route('admin.trackInvoice',['invoice_id'=>$session['invoice']->id]);
        }else{
          $link = '#';
        }
      ?>
    ...
    <td width="12%" align="center" class="order-process">
      <?php
        if(isset($session['invoice'])){
          $link = route('admin.documentCopies',['invoice_id'=>$session['invoice']->id]);
        }else{
          $link = '#';
        }
      ?>
    ...
    <td width="12%" align="center" class="order-process">
      <a href="#" class="order-process"><img src="{{URL::to('/')}}/assets/images/step7.png" alt="step7"><br>
    ...
    <td width="12%" align="center" class="order-process">
      <?php
        if(isset($session['invoice'])){
          $link = route('admin.receivedItem',['negotiation_id'=>$session['negotiation']->id]);
        }else{
          $link = '#';
        }
      ?>
