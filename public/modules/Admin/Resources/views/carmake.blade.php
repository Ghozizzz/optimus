  ...
  <div class='col-md-9' align='right'>
	...
	<tbody>
		...
		<tr>
			<td>{{ $i }}</td>
      		<th> {{ $d->make }} </th>
			<td><img width="50" height="50" src="{{ URL::to('/') }}/{{ $d->logo }}" alt=""></td>
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="newMake">
             ...
             <div class="form-group">
            <label class="col-form-label">Corporate:</label>
            <input type="text" class="form-control" id="newCorporate">
          </div>
        </form>
      </div>
        ...
        <form>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="editMake">
             ...
             <div class="form-group">
            <label class="col-form-label">New Corporate:</label>
            <input type="text" class="form-control" id="editCorporate">
          </div>
        </form>
      </div>
      <div class="modal-footer">
...
$('#editModal').on('show.bs.modal', function (event) {
  ...
  var modal = $(this)
    ...
    console.log(response);
		...
		modal.find('#editImage').attr('src', "{{ URL::to('/') }}" + response.logo);
	});
})
function updateData(){
