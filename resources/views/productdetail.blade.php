          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-12" align='center' style="width: 100%;">
                ...
                <img id='main-picture' class='main-picture img-responsive'src="{{URL::to('/')}}/uploads/car/{{$picture_arr[0]->picture}}" alt="{{$car->description}}" style="border-radius:5px; width: 80%; height: auto; border: 1px solid #000;">
                @endif
              </div>
