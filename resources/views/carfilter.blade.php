<div class="col-md-2 car-filter">
      ...
      <div class="accordion" id="carsidesearch">
        <div class="carsidesearch-group">
          <div class="carsidesearch-btn collapsed paddingleft30" data-toggle="collapse" data-target="#carsidesearch1">
            Make
          </div>
          <div id="carsidesearch1" class="collapse" data-parent="#carsidesearch">
            <div class="make paddingleft30">
        ...
        <div class="carsidesearch-group">
          <div class="carsidesearch-btn collapsed paddingleft30" data-toggle="collapse" data-target="#carsidesearch2">
            Type
          </div>
          <div id="carsidesearch2" class="collapse" data-parent="#carsidesearch">
            <div class="type paddingleft30">
...
<!--        <div class="carsidesearch-group">
        ...
        <div class="carsidesearch-group">
          <div class="carsidesearch-btn collapsed paddingleft30" data-toggle="collapse" data-target="#carsidesearch4">
            FOB Price
          </div>
          <div id="carsidesearch4" class="collapse" data-parent="#carsidesearch">
            <div class="price paddingleft30">
              <ul class="menu nav nav-pills flex-column"><!-- html to include -->
