                ...
                <div class='row padding5'>
                  ...
                  <div class='col-md-9'>
                    ...
                    <div class='row'>
                      ...
                      <div class='col-md-6'>
                        <textarea name='address' id='address' class="form-control">{{isset($session['invoice']->street_address) && $session['invoice']->street_address !== '' ?$session['invoice']->street_address : $accounts[0]->address}}</textarea>
                      </div>
                    </div>
                    <div class='row'>
                      <div class='col-md-6'>
...
<script>  
  ...
  function updateInvoice(step){
    ...
    $.ajax({
      ...
      url: "{{route('customer.updateInvoice')}}",
      data: requestData,
      type: 'post',
      dataType: 'json',
      beforeSend: function () {
