          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-xs-12" align='center'>
                ...
                <img id='main-picture' class='main-picture img-responsive' width='70%' src="{{URL::to('/')}}/uploads/car/{{$picture_arr[0]->picture}}" alt="{{$car->description}}" style="border-radius:5px;">
                @endif
              </div>
        ...
        <div class="col-lg-5 col-md-6">
          <div class="mini-box">
            ...
            <form onsubmit="return negotiationCheck()" action="{{route('customer.negotiate')}}" method="post">
              ...
              <div class='totalprice-div' style='display:none'>C&F: <span id='currency-symbol' class="red-color">{{$car->currency}}</span> 
        ...
        <div class="col-lg-10">
          <div id="cardetailtabs" class="cardetailtabs">             
            ...
            <div class="tab-content">
              <div id="detailtabs-1" class="tab-pane fade in active show">
                <div class='row'>
                  <div class="col-md-6">
...
<script>
  ...
  $("#calculate").on('click',function(){
    ...
    if($("#destination_port option:selected").data('vprice') != null && parseFloat($("#destination_port option:selected").data('vprice')) != 0 && car_volume != 0){
      var shipping_price = parseFloat($("#destination_port option:selected").data('vprice')) * car_volume;
    }else if($("#destination_port option:selected").data('price')){
      var shipping_price = parseFloat($("#destination_port option:selected").data('price'));
    }else{
